          ...
          <div class="col-md-5 mx-7 card shadow" style={{padding:"20px"}}>
           ...
           <form onSubmit={handleSubmit(change)}>
              <div>
               ...
               {errors.email1 && <span style={{color:"red",fontWeight:"700",fontSize:"12px"}}>Empty Field or length must be greater then 15 or ex.anujsundriyal1234@gmail.com</span>}
               ...
               {/* <span style={{color:'red',fontWeight:"700"}}>{passvalid}</span> */}
                ...
                <br/>
                <div>
               <input  type="date" placeholder="Enter Date" className="form-control mt-4 " onChange={DC} autoComplete="off" required/>
